...
class EnqueueScripts
{
    ...
    public function _registerScripts()
    {
        ...
        if (file_exists(base_path('awe-custom/Assets/css/awe-custom.css')) && is_dir(public_path('awe-custom'))) {
            $this->addStyle('awe-custom', asset('awe-custom/Assets/css/awe-custom.css'), false, true);
        }

        if (file_exists(base_path('awe-custom/Assets/js/awe-custom.js')) && is_dir(public_path('awe-custom'))) {
