            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                    ...
                    @if ($allCoupons['total'])
                        @foreach ($allCoupons['results'] as $item)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <p class="mb-0"><i
                                            class="text-muted exp">{{ get_translate($item->coupon_description) }}</i>
                                    </p>
                                </td>
                                ...
                                <td class="align-middle">
                                    <div>
                                        ...
                                        <span class="exp d-none">
                                            {{ date(hh_date_format(), $item->start_time) }} to {{ date(hh_date_format(), $item->end_time) }}
                                        </span>
                                    </div>
                                </td>
                                <td class="align-middle text-center">
                    ...
                    @else
                        <tr>
                            <td colspan="6">
                                <h4 class="mt-3 text-center">{{__('No coupon yet.')}}</h4>
                            </td>
                        </tr>
                    @endif
                    </tbody>
