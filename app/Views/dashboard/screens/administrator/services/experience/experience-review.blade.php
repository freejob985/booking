...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Experience Reviews')])
            {{--Start Content--}}
            <div class="card-box">
                @if(enable_review())
                        ...
                        @if ($comments['total'])
                            @foreach ($comments['results'] as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ get_experience_permalink($item->post_id, $item->post_slug) }}">{{ get_translate($item->post_title) }}</a>
                                    </td>
                                    <td class="align-middle">
