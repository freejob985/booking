        ...
        <div class="content">
            ...
            <div class="card-box card-list-post">
                <div class="header-area d-flex align-items-center">
                    <h4 class="header-title mb-0">{{__('All Pages')}}</h4>
                ...
                <div class="action-toolbar">
                    <form class="hh-form form-inline" action="{{dashboard_url('page-bulk-actions')}}"
                ...
                <table id="table-my-page" class="table table-large mb-0 dt-responsive nowrap w-100"
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0 title-overflow">
                                                <a class="text" href="{{ get_the_permalink($item->post_id, $item->post_slug, 'page') }}"
                                                   target="_blank">
                                            ...
                                            <div class="quick-action-links d-none d-md-block">
                                                <a class="quick-link-item" target="_blank"
                                                   href="{{ url('dashboard/edit-page/' . $item->post_id ) }}">{{__('Edit')}}</a>
                                                @if($item->status != 'trash')
                                                    ...
                                                    @if($item->status == 'publish')
                                                        <a class="quick-link-item"
                                                           href="{{ get_the_permalink($item->post_id, $item->post_slug, 'page') }}"
                    ...
                    @else
                        <tr>
                            <td colspan="6">
                                <h4 class="mt-3 text-center">{{__('No pages yet.')}}</h4>
                            </td>
                        </tr>
                    @endif
                    </tbody>
