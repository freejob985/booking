...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Car Equipments')])
            {{--Start Content--}}
            <?php
            ...
            <div class="card-box">
                <div class="header-area d-flex align-items-center">
                    <h4 class="header-title mb-0">{{__('All Equipments')}}</h4>
                    ...
                    @if ($allTerms['total'])
                        @foreach ($allTerms['results'] as $item)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <p class="mb-0"><i class="text-muted">{{ convert_price ($item->term_price) }}</i>
                                    </p>
                                </td>
                                <td class="align-middle">
                                    <p class="mb-0"><i
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               ...
                                               data-target="#hh-update-car-equipments-modal">{{__('Edit')}}</a>
            ...
            <div id="hh-update-car-equipments-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog"
                 aria-hidden="true"
                 data-url="{{ dashboard_url('get-term-item/car-equipment') }}">
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('Update Car Equipments')}}</h4>
