                                ...
                                <td class="align-middle text-center">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            ?>
                                            @foreach($payout_status_info as $key => $status)
                                                <?php
                                                $data = [
                                                    'payoutID' => $item->ID,
                                                    'payoutEncrypt' => hh_encrypt($item->ID),
                                                ...
                                                <a class="dropdown-item hh-link-action hh-link-change-status-payout"
                                                   data-action="{{ dashboard_url('change-status-payout') }}"
                                                   data-parent="tr"
                                            ...
                                            <a class="dropdown-item hh-link-action hh-link-delete-payout"
                                               data-action="{{ dashboard_url('delete-payout-item') }}"
                                               data-parent="tr"
                                               data-is-delete="true"
                                               data-confirm="yes"
                                               data-confirm-title="{{__('System Alert')}}"
                                               data-confirm-question="{{__('Are you sure want to delete this item?')}}"
